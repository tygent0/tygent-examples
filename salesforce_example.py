...
try:
    ...
    from tygent.integrations.salesforce import SalesforceIntegration, TygentBatchProcessor
except ImportError:
...
async def main():
    ...
    print(f"Analyzing high-value accounts in the {inputs['industry_focus']} industry...")
